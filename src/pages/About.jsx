    ...
    <div className='w-full h-screen bg-gray-100 about_container'  id='about'>
      <div className='flex w-full h-full bg-gray-white justify-center'>
        <div className='flex justify-center flex-col items-center bg-white w-2/5 h-full gap-6'>
         ...
         <div className='w-4/5'>
          <button className='btn btn-active btn-primary z-10'>Download CV</button>
  
         </div>
           
          <div className='w-4/5 flex  gap-3'>
            <button className='btn btn-active btn-primary rounded-full text-white'><FaInstagram className='w-4/5 h-4/5'/></button>
            <button className='btn btn-active btn-primary rounded-full text-white'><FaFacebook className='w-4/5 h-4/5'/></button>
            <button className='btn btn-active btn-primary rounded-full text-white'><FaGithub  className='w-4/5 h-4/5'/></button>
          </div>
